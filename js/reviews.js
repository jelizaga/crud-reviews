...
var addReview = function(rev) {
	...
	// Constructing review.
	var oneReview = $("<div class='islandDiv'><p class='bold'>" + reviewTitle + "</p><text>a review by <span class='italic'>" + reviewerName + "</span></text><p>" + reviewStars + "</p><p>" + reviewText + "</p></div>");
